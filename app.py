...
def buscar_todas_noticias(ticker_bdr, ticker_us, empresa_nome, setor):
    """Agrega notícias de múltiplas fontes, deduplica e retorna até 12."""
    todas = []
...
def renderizar_card_noticia(noticia, idx):
    ...
    <div style='background: {bg}; border: 1px solid {badge_bg}; border-radius: 10px;
        ...
        <div style='display: flex; justify-content: space-between; align-items: flex-start; gap: 0.5rem;'>
            <a href="{link}" target="_blank" style='font-size: 0.92rem; font-weight: 600;
               color: #1e293b; text-decoration: none; line-height: 1.35; flex: 1;'>{titulo}</a>
