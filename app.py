...
def analisar_oportunidades(df_calc, mapa_nomes):
    ...
    for ticker in tickers:
        try:
            ...
            # === RANKING DE ESTABILIDADE (0-10, inverso — 10=mais estável) ===
            try:
                ...
                saltos       = (retornos.abs() > 3).sum() / len(retornos) * 100
                penalidade   = 0
                # ATR % (até 40 pts)
                ...
                # Saltos > 3% (até 25 pts)
                if   saltos > 30:   penalidade += 25
                elif saltos > 20:   penalidade += 18
                elif saltos > 10:   penalidade += 10
                elif saltos > 5:    penalidade += 5
                ranking_estab = max(0, min(10, round((100 - penalidade) / 10)))
            except Exception:
                ranking_estab = 5
